...
export const CardOptionMenu = ({ title, Icon, route, type }: Props) => {
  ...
  const getCardColor = () => {
    ...
    if (badgeCount > 0) {
      switch (type) {
        ...
        default:
          return 'border-gray-300 hover:border-gray-400 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600';
      }
    }
  ...
  return (
    ...
    >
      <UI.CardBody className="center-flex-col p-4 sm:p-5 h-full overflow-hidden justify-center">
        ...
        <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-center text-gray-800 dark:text-gray-200 flex-shrink-0 leading-tight px-2">
          {title}
        </h3>
      </UI.CardBody>
    </UI.Card>
